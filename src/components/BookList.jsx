      ...
      render: (text, record) => (
        <Space>
          ...
          <Button 
            ...
            type={record.isLiked ? "primary" : "default"} 
            danger={record.isLiked}
           
            icon={record.isLiked ? <HeartFilled /> : <HeartOutlined />}
            onClick={() => props.onLiked(record)}
          >
            {record.isLiked ? 'Liked' : 'Like'}
          </Button>
